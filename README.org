...
- [[https://en.wikipedia.org/wiki/Lambda_calculus][Lambda calculus (Wikipedia[en])]]

* Encodings
** De Bruijn indices
*** Introductory
- [[https://en.wikipedia.org/wiki/De_Bruijn_index][De Bruijn index (Wikipedia[en])]]
- [[https://en.wikipedia.org/wiki/De_Bruijn_notation][De Bruijn notation (Wikipedia[en])]]
*** Discussions
...
** SKI combinators
- [[https://en.wikipedia.org/wiki/SKI_combinator_calculus][SKI combinator calculus (Wikipedia[en])]]
...
- [[https://en.wikipedia.org/wiki/Mogensen%E2%80%93Scott_encoding][Mogensen–Scott encoding (Wikipedia[en])]]
...
* System F
- [[https://en.wikipedia.org/wiki/System_F][System F (Wikipedia[en])]]
